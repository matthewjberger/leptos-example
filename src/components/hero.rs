    ...
    view! {
        <section id="hero" class="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
            <div class="text-center px-4">
                <img
                    src="https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=180&h=180&fit=crop&crop=face"
                ...
                <h1 class="text-5xl md:text-7xl font-bold text-gray-900 dark:text-white mb-4">
                    "Hi, I'm " <span class="text-blue-600 dark:text-blue-400">"Richard Hendricks"</span>
                </h1>
                <p class="text-xl md:text-2xl text-gray-700 dark:text-gray-300 mb-8">
                    "CEO & Founder at Pied Piper"
                </p>
                <div class="flex gap-4 justify-center flex-wrap">
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        class="px-6 py-3 bg-gray-800 dark:bg-gray-700 text-white rounded-lg hover:bg-gray-900 dark:hover:bg-gray-600 transition-colors inline-flex items-center gap-2 whitespace-nowrap"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0" style="width: 14px; height: 14px;" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <a
                        href="#projects"
                        class="px-6 py-3 bg-teal-500 text-white rounded-lg hover:bg-teal-600 transition-colors inline-flex items-center gap-2 whitespace-nowrap"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0" style="width: 14px; height: 14px;" viewBox="0 0 20 20" fill="currentColor">
